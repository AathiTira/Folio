  ...
  return (
    <div className="w-full">
      ...
      items-center mt-4 md:mt-8 lg:mt-10">
        ...
        <Link to={"https://www.instagram.com/_aathithya_12/"} target="_blank">
          <Instagram className="text-pink-500 w-7 h-7" />
        </Link>
        {/* <Link to={user.facebookURL} target="_blank">
          <Facebook className="text-blue-800 w-7 h-7" />
        </Link> */}
        <Link to={"https://www.linkedin.com/in/aathithya-tiraviam-s-7a1300310"} target="_blank">
          <Linkedin className="text-sky-500 w-7 h-7" />
        </Link>
        <Link to={"https://x.com/AathiTira"} target="_blank">
          <Twitter className="text-blue-800 w-7 h-7" />
        </Link>
      </div>
      <div className="mt-4 md:mt-8 lg:mt-10  flex gap-3">
        <Link to={"https://github.com/AathiTira"} target="_blank">
