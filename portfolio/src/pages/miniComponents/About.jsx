      ...
      <div>
        <div className="grid md:grid-cols-2 my-8 sm:my-20 gap-14">
          ...
          <div className="flex justify-center flex-col tracking-[1px] text-xl gap-5">
            <p>
            I'm an undergrad student at NIT Trichy. I currently live in Trichy, Tamil Nadu, India. I'm a Full Stack Web Developer. 
            I'm interested in the Java language in itself.
            </p>
            <p>
              ...
              my work. In my free time you may find me reading fiction, watching action films or 
